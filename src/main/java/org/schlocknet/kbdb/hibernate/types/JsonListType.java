 ...
 * @author Ryan
 *
 * An attempt at a Hibernate custom type to make a JSON string to a java list type
 *
 */
public class JsonListType implements UserType
{
  ...
  public Object nullSafeGet(ResultSet rs, String[] strings, SharedSessionContractImplementor ssci, Object o) throws HibernateException, SQLException
  {
    ...
    String jsonValue = rs.getString(strings[0]);
    if (jsonValue != null)
    {
      try
      {
  ...
  public void nullSafeSet(PreparedStatement ps, Object value, int index, SharedSessionContractImplementor ssci) throws HibernateException, SQLException
  {
    ...
    {
      ps.setString(index, gson.toJson(value));
    }
  }
